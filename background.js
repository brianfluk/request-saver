...
var defaultTarget = "https://api-stage.customer-engagement.ibm.com";
// var defaultMock = "https://mock-server1.fyre.ibm.com:3000/";
// var defaultMock = "http://mock-server1.fyre.ibm.com:4000/";
var defaultMock = "http://localhost:4000/";
...
chrome.runtime.onInstalled.addListener(function () {
    ...
    chrome.webRequest.onBeforeRequest.addListener(async function(details) {
        let callCount = `c${callCountTotal}`;
        callCountTotal ++;
        if (! recording) {
